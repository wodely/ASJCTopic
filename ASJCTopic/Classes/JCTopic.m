...
- (id)initWithFrame:(CGRect)frame withcolor:(BOOL)color
{
    ...
    if (self) {
        ...
        imageview.image=[UIImage imageNamed:@"ad_placher.png"];
...
-(void)upDate{
    ...
    if (self.pics.count > 0) {
        ...
        for (id obj in self.pics) {
            ...
            [tempImage sd_setImageWithURL:[NSURL URLWithString:obj] placeholderImage:[UIImage imageNamed:@"ad_placher.png"]];
